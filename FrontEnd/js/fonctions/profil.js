...
function templateLabelBtnProfil__Origin() {
  ...
  document
    .querySelector("#profilView")
    .classList.remove("addPicture__logo--full");
  document
    .querySelector("#profilView")
    .classList.add("addPicture__logo--empty");
  document.querySelector("#profilForm .addPicture__btn").style =
    "display:null;";
  document.querySelector("#profilForm .contener__label p").style =
    "display:block;";
}
